...
Всеукраинский конкурс современной эстрадной и рок музыки «Рок єднає нас» 2015 рассчитан на учеников музыкальных школ, колледжей, а так же других молодых людей, которые стремятся проявить и реализовать свои способности в музыкальном направлении.
...
Общее время выступления конкурсанта не должно превышать **8 минут** (без учета подготовки к выступлению).
...
* Ансамблевое исполнение. Ансамбли размером 2-6 человек. Возраст музыкантов не учитывается

## Участие в конкурсе

Отборочный этап конкурса будет проходить онлайн. Для участия необходимо предоставить демо-записи конкурсной программы. Это можно сделать оставив <?= CHtml::link('онлайн-заявку', array('apply')) ?>, указав в ней ссылки на демо-записи (например для видео [Youtube](http://youtube.com) или [Soundcloud](http://soundcloud.com) для аудио файлов). Если по каким-то причинам у Вас не выходит загрузить демо-записи в интернет, оставьте онлайн заявку с той информацией, которую Вы можете предоставить и <?= CHtml::link('свяжитесь', array('site/contact')) ?> с нами.

Все, кто пройдут в финал, будут проинформированы о дате и времени саундчека и выступления по email или телефону, которые они указали в онлайн заявке.
...
* Ансамбли — 50 грн. с каждого члена ансамбля.
